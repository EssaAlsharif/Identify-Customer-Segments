...
Reconstruct and interpret cluster centroids
...
PCA: Reduce dimensionality and analyze components

Clustering: Apply K-Means to find segments

Centroid Reconstruction: Transform cluster centers back to original feature space
...
Explained PCA component contributions

Interpreted each cluster’s socio-economic characteristics
